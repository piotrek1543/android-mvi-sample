...
import com.piotrek1543.example.todoapp.data.succeeded
...
@MediumTest
class TasksCachedDataSourceTest {

    private lateinit var localDataSource: TasksCachedDataSource
    ...
    fun setup() {
        ...
        localDataSource = TasksCachedDataSource(database.taskDao(), ioDispatcher = Dispatchers.Main)
    }
