 ...
 */
package com.piotrek1543.example.todoapp.cache.repository

import com.google.common.truth.Truth.assertThat
import com.piotrek1543.example.todoapp.cache.FakeDataSource
...
class TasksDataRepositoryTest {
    ...
    // Class under test
    private lateinit var tasksRepository: TasksDataRepository
    ...
    fun createRepository() {
        ...
        tasksRepository = TasksDataRepository(
                tasksRemoteDataSource, tasksLocalDataSource, ioDispatcher = Dispatchers.Unconfined
        )
    }
    ...
    fun getTasks_emptyRepositoryAndUninitializedCache() = runBlockingTest {
        ...
        val tasksRepository = TasksDataRepository(
                emptySource, emptySource, ioDispatcher = Dispatchers.Unconfined
        )
